...
const translations = {
  en: {
    ...
    'rating.loss': '⚫ Loss',
    'table.contributions': 'Contributions',
    'table.interest': 'Interest Earned',
    'table.gross_interest': 'Gross Interest',
    'table.net_interest': 'Net Interest',
    'table.tax': 'Tax',
    'table.period': 'Period',
    'frequency.end': 'At maturity',
    'toggle.yearly': 'By Year',
    'toggle.period': 'By Period',
    'button.show_details': 'Show Detailed Breakdown',
    'button.hide_details': 'Hide Details',
    'button.export_excel': 'Export to CSV',
    'result.tax': 'Tax Paid',
    'result.effective_rate': 'Effective Annual Return',
    'LABEL.CAPITALIZATION': 'Capitalization Frequency',
    'LABEL.CONTRIBUTIONS': 'Regular Contributions',
    'LABEL.TAX': 'Tax Rate',
    'form.contribution_amount': 'Contribution amount',
    'form.contribution_frequency': 'Contribution frequency',
    'hint.tax': 'Choose resident (13%) or non-resident (30%) Russian tax rates.',
  },

...
const translations = {
  en: {
    ...
    'section.schedule': 'Amortization Schedule',
    'section.goal': 'Goal Settings',
    'section.milestones': 'Savings Milestones',
    'section.extra': 'Extra Payments',
    'section.paymentHistory': 'Payment History',
    'section.cardDebt': 'Card Debt Details',
    'section.custom': 'Custom Monthly',
    'section.additional': 'Additional Costs',
    'section.comparison': 'Cost Breakdown',
    ...
    'result.finalAmount': 'Final Amount',
    'result.invested': 'Total Invested',
    'result.interest': 'Interest Earned',
    'result.growth': 'Growth',
    'result.realValue': 'Real Value (inflation adj.)',
    'result.monthlyPayment': 'Monthly Payment',
    'result.monthlyRequired': 'Monthly Required',
    'result.targetAmount': 'Target Amount',
    'result.loanAmount': 'Loan Amount',
    'result.totalPayments': 'Total Payments',
    'result.totalAmount': 'Total Amount',
    'result.payoffTime': 'Payoff Time',
    'result.payoffDate': 'Payoff Date',
    'result.goalDate': 'Goal Date',
    'result.homeValue': 'Home Value',
    'result.downPayment': 'Down Payment',
    'result.interestRatio': 'Interest Ratio',
    'result.extraSavings': 'Extra Payments Savings',
    'result.annualizedReturn': 'Annualized Return',
    'result.netProfit': 'Net Profit',
    'result.holdingPeriod': 'Holding Period',
    'result.totalGain': 'Total Gain/Loss',
    'result.initialInvestment': 'Initial Investment',
    'result.finalValue': 'Final Value',
    'result.profitable': 'Profitable Investment',
    'result.progress': 'Progress to Goal',
    'result.deposits': 'Deposits',
    'result.interestEarned': 'Interest Earned',
    'result.totalPayment': 'Total Payment',
    'result.totalInterest': 'Total Interest',
    'result.monthlyNeeded': 'Monthly Savings',
    'result.goalAmount': 'Goal Amount',
    'result.interestEarned': 'Interest Earned',
    'result.totalCost': 'Total Cost',
    'result.payoffTime': 'Payoff Time',
    'result.remainingBalance': 'Remaining Balance',
    'result.roi': 'ROI',
    'result.netProfit': 'Net Profit',
    'result.annualizedROI': 'Annualized ROI',
    ...
    'form.initialSavings': 'Initial Savings',
    'form.timeframe': 'Timeframe',
    'form.homePrice': 'Home Price',
    'form.downPayment': 'Down Payment',
    'form.currentBalance': 'Current Balance',
    'form.annualRate': 'Annual Rate (APR) %',
    'form.holdingPeriod': 'Holding Period',
    'form.homeValue': 'Home Value',
    'form.downPayment': 'Down Payment',
    'form.loanTerm': 'Term',
    'form.loanAmount': 'Loan Amount',
    'form.paymentType': 'Payment Type',
    'form.initialInvestment': 'Initial Investment',
    'form.finalValue': 'Final Value',
    'form.targetAmount': 'Target Amount',
    'form.initialSavings': 'Initial Savings',
    'form.timeframe': 'Timeframe',
    'form.fixedMonthly': 'Fixed Monthly Amount',
    'form.extraMonthly': 'Extra Monthly',
    'form.fees': 'Fees & Commissions',
    'form.dividends': 'Dividends Received',
    'form.quickExamples': 'Quick Examples',
    'form.apr': 'APR (%)',
    'form.monthlyPayment': 'Monthly Payment',
    'form.initialInvestment': 'Initial Investment',
    'form.finalValue': 'Final Value',
    'form.investmentPeriod': 'Investment Period (Months)',
    
    // Chart Titles
    'chart.paymentBreakdown': 'Payment Breakdown',
    'chart.progressChart': 'Progress Chart',
    'chart.amortization': 'Amortization',
    'chart.balanceOverTime': 'Balance Over Time',
    'chart.investmentBreakdown': 'Investment Breakdown',
    ...
    'button.share': 'Share',
    'button.save': 'Save',
    'button.fullCalculator': 'Full Calculator',
    'button.viewAll': 'View All',
    'button.viewAllNews': 'All News',
    'button.readMore': 'Read More →',
    
    // News categories and placeholders
    'news.markets': 'Markets',
    'news.investments': 'Investments',
    'news.deposits': 'Deposits',
    'news.realestate': 'Real Estate',
    'news.crypto': 'Crypto',
    'news.economy': 'Economy',
    'news.placeholder1.title': 'Central Bank Monetary Policy Update',
    'news.placeholder1.desc': 'Latest decisions on key interest rates and economic outlook.',
    'news.placeholder2.title': 'Stock Market Daily Highlights',
    'news.placeholder2.desc': 'Key movements and trends in equity markets today.',
    'news.placeholder3.title': 'Best Deposit Rates This Month',
    'news.placeholder3.desc': 'Compare top bank deposit offers and maximize your returns.',
    'news.placeholder4.title': 'Mortgage Market Overview',
    'news.placeholder4.desc': 'Current mortgage rates and lending conditions analysis.',
    'news.placeholder5.title': 'Cryptocurrency Market Update',
    'news.placeholder5.desc': 'Bitcoin and major altcoins price movements and trends.',
    'news.placeholder6.title': 'Economic Indicators Report',
    'news.placeholder6.desc': 'Inflation, GDP and key economic metrics update.',
    
    // Article short descriptions
    'article.compound.short': 'Learn how compound interest can grow your wealth exponentially over time.',
    'article.savings.short': 'Discover proven methods to save money and reach your financial goals.',
    'article.debt.short': 'Compare avalanche vs snowball methods to pay off debt faster.',
    'article.mortgage.short': 'Everything you need to know before buying your first home.',
    'article.invest.short': 'Start your investment journey with these fundamental concepts.',
    'article.emergency.short': 'Why you need an emergency fund and how to build one.',
    'article.savings.title': 'Smart Savings Strategies',
    'article.debt.title': 'Debt Payoff Strategies',
    'article.mortgage.title': 'Mortgage Guide for Beginners',
    'article.invest.title': 'Investment Basics 101',
    'article.emergency.title': 'Building Emergency Fund',
    
    'form.submit': 'Calculate',
    
    // Chart
    'chart.growthTitle': 'Growth Chart',
    'chart.amortization': 'Amortization',
    'chart.breakdown': 'Payment Breakdown',
    'chart.savingsGrowth': 'Savings Growth',
    'chart.balancePayoff': 'Balance Payoff',
    'chart.valueComparison': 'Value Comparison',
    
    // Payment types
    'payment.annuity': 'Annuity (fixed)',
    'payment.differentiated': 'Differentiated',
    
    // Hints
    'hint.fixedMonthly': 'Set to 0 for auto-calculation',
    
    // ROI status
    'result.roi': 'Return on Investment',
    ...
    'table.initialBalance': 'Initial Balance',
    'table.finalBalance': 'Final Balance',
  ...
  pl: {
    ...
    'form.initialAmount': 'Kwota początkowa',
    'form.monthly': 'Miesięczna wpłata',
    'form.rate': 'Stopa procentowa (%)',
    'form.interestRate': 'Stopa procentowa (%)',
    'form.years': 'Lata',
    'form.months': 'Miesiące',
    'form.term': 'Okres',
    'form.compounding': 'Kapitalizacja',
    'form.parameters': 'Parametry',
    'form.quickPresets': 'Szybkie ustawienia',
    'form.quarterly': 'Kwartalnie',
    'form.annually': 'Rocznie',
    'form.daily': 'Codziennie',
    ...
    'section.schedule': 'Harmonogram Spłat',
    'section.goal': 'Ustawienia Celu',
    'section.milestones': 'Kamienie Milowe Oszczędności',
    'section.extra': 'Dodatkowe Płatności',
    'section.paymentHistory': 'Historia Płatności',
    'section.cardDebt': 'Szczegóły Zadłużenia Karty',
    'section.custom': 'Niestandardowa Miesięczna',
    'section.additional': 'Dodatkowe Koszty',
    'section.comparison': 'Podział Kosztów',
    'section.loan': 'Szczegóły kredytu',
    'section.savings': 'Szczegóły oszczędności',
    'section.mortgage': 'Szczegóły hipoteki',
    'section.credit': 'Szczegóły karty kredytowej',
    ...
    'result.finalAmount': 'Kwota końcowa',
    ...
    'chart.year': 'Rok',
    'chart.month': 'Miesiąc',
    'chart.growthTitle': 'Wykres wzrostu',
    'chart.amortization': 'Amortyzacja',
    'chart.breakdown': 'Podział płatności',
    'chart.savingsGrowth': 'Wzrost oszczędności',
    'chart.balancePayoff': 'Spłata salda',
    'chart.valueComparison': 'Porównanie wartości',
    
    // Payment types
    'payment.annuity': 'Annuitetowa (stała)',
    'payment.differentiated': 'Zróżnicowana',
    
    // Hints
    'hint.fixedMonthly': 'Ustaw 0 dla automatycznego obliczenia',
    
    // ROI status
    'result.roi': 'Zwrot z Inwestycji',
    ...
    'table.period': 'Okres',
    'table.initialBalance': 'Saldo początkowe',
    'table.finalBalance': 'Saldo końcowe',
    'table.balance': 'Saldo',
    'table.additions': 'Wpłaty',
    'table.withdrawals': 'Wypłaty',
    'table.tax': 'Podatek',
    'table.milestone': 'Kamień milowy',
    'table.amount': 'Kwota',
    'table.date': 'Data',
    'result.tax': 'Potrącony Podatek',
    'result.growth': 'Wzrost',
    'result.realValue': 'Realna Wartość (po inflacji)',
    'result.monthlyPayment': 'Rata miesięczna',
    'result.monthlyRequired': 'Wymagana miesięczna kwota',
    'result.targetAmount': 'Kwota docelowa',
    'result.loanAmount': 'Kwota kredytu',
    'result.totalPayments': 'Suma płatności',
    'result.totalAmount': 'Całkowita kwota',
    'result.payoffTime': 'Czas spłaty',
    'result.payoffDate': 'Data spłaty',
    'result.goalDate': 'Data celu',
    'result.homeValue': 'Wartość nieruchomości',
    'result.downPayment': 'Wkład własny',
    'result.interestRatio': 'Udział odsetek',
    'result.extraSavings': 'Oszczędności z dodatkowych płatności',
    'result.annualizedReturn': 'Roczny zwrot',
    'result.netProfit': 'Zysk netto',
    'result.holdingPeriod': 'Okres posiadania',
    'result.totalGain': 'Całkowity zysk/strata',
    'result.initialInvestment': 'Początkowa inwestycja',
    'result.finalValue': 'Wartość końcowa',
    'result.profitable': 'Zyskowna inwestycja',
    'result.progress': 'Postęp do celu',
    'result.deposits': 'Wpłaty',
    'result.interestEarned': 'Zarobione odsetki',
    'result.totalPayment': 'Całkowita kwota',
    'result.totalInterest': 'Łączne odsetki',
    'result.monthlyNeeded': 'Miesięczne oszczędności',
    'result.goalAmount': 'Kwota docelowa',
    'result.interestEarned': 'Naliczone odsetki',
    'result.totalCost': 'Całkowity koszt',
    'result.payoffTime': 'Czas spłaty',
    'result.remainingBalance': 'Saldo',
    'result.roi': 'Zwrot z inwestycji',
    'result.netProfit': 'Zysk netto',
    'result.annualizedROI': 'Roczna stopa zwrotu',
    'result.principal': 'Kapitał',
    'result.contributions': 'Wpłaty',
    'result.profit': 'Zysk',
    
    // Additional Form Labels
    'form.loanAmount': 'Kwota kredytu',
    'form.loanTerm': 'Okres kredytowania',
    'form.targetAmount': 'Kwota docelowa',
    'form.initialSavings': 'Początkowe oszczędności',
    'form.timeframe': 'Okres',
    'form.homePrice': 'Cena nieruchomości',
    'form.downPayment': 'Wkład własny',
    'form.currentBalance': 'Bieżące saldo',
    'form.annualRate': 'Roczna stopa (APR) %',
    'form.holdingPeriod': 'Okres posiadania',
    'form.homeValue': 'Wartość nieruchomości',
    'form.downPayment': 'Wkład własny',
    'form.loanTerm': 'Termin',
    'form.loanAmount': 'Kwota kredytu',
    'form.paymentType': 'Typ płatności',
    'form.initialInvestment': 'Początkowa inwestycja',
    'form.finalValue': 'Wartość końcowa',
    'form.targetAmount': 'Kwota docelowa',
    'form.initialSavings': 'Początkowe oszczędności',
    'form.timeframe': 'Ramy czasowe',
    'form.fixedMonthly': 'Stała kwota miesięczna',
    'form.extraMonthly': 'Dodatkowa miesięczna',
    'form.fees': 'Opłaty i prowizje',
    'form.dividends': 'Otrzymane dywidendy',
    'form.quickExamples': 'Szybkie przykłady',
    'form.apr': 'RRSO (%)',
    'form.monthlyPayment': 'Rata miesięczna',
    'form.initialInvestment': 'Inwestycja początkowa',
    'form.finalValue': 'Wartość końcowa',
    'form.investmentPeriod': 'Okres inwestycji (miesiące)',
    
    // Chart Titles
    'chart.paymentBreakdown': 'Struktura płatności',
    'chart.progressChart': 'Wykres postępu',
    'chart.amortization': 'Amortyzacja',
    'chart.balanceOverTime': 'Saldo w czasie',
    'chart.investmentBreakdown': 'Struktura inwestycji',
    ...
    'button.save': 'Zapisz',
    'button.fullCalculator': 'Pełny kalkulator',
    'button.viewAll': 'Zobacz wszystko',
    'button.viewAllNews': 'Wszystkie wiadomości',
    'button.readMore': 'Czytaj więcej →',
    'form.submit': 'Oblicz',
  ...
  ru: {
    ...
    'form.initialAmount': 'Начальная сумма',
    'form.monthly': 'Ежемесячный взнос',
    'form.rate': 'Процентная ставка (%)',
    'form.interestRate': 'Процентная ставка (%)',
    'form.years': 'Годы',
    'form.parameters': 'Параметры',
    'form.term': 'Срок',
    'form.months': 'Месяцы',
    'form.compounding': 'Капитализация',
    'form.quarterly': 'Ежеквартальная',
    'form.yearly': 'Ежегодная',
    'form.daily': 'Ежедневная',
    'form.quickPresets': 'Быстрые настройки',
    ...
    'table.initialBalance': 'Начальный баланс',
    'table.finalBalance': 'Конечный баланс',
    'table.balance': 'Баланс',
    'table.additions': 'Пополнения',
    'table.withdrawals': 'Снятия',
    'table.tax': 'Налог',
    'table.milestone': 'Этап',
    'table.amount': 'Сумма',
    'table.date': 'Дата',
    'result.tax': 'Удержанный налог',
    'result.total': 'Итоговая сумма',
    'result.finalAmount': 'Итоговая сумма',
    'result.invested': 'Всего вложено',
    'result.interest': 'Начисленные проценты',
    'result.growth': 'Рост',
    'result.realValue': 'Реальная стоимость (с учётом инфляции)',
    'result.monthlyPayment': 'Ежемесячный платёж',
    'result.monthlyRequired': 'Требуется ежемесячно',
    'result.targetAmount': 'Целевая сумма',
    'result.loanAmount': 'Сумма кредита',
    'result.totalPayments': 'Всего платежей',
    'result.totalAmount': 'Общая сумма',
    'result.payoffTime': 'Срок погашения',
    'result.payoffDate': 'Дата погашения',
    'result.goalDate': 'Дата достижения цели',
    'result.homeValue': 'Стоимость недвижимости',
    'result.downPayment': 'Первоначальный взнос',
    'result.interestRatio': 'Доля процентов',
    'result.extraSavings': 'Экономия от доп. платежей',
    'result.annualizedReturn': 'Годовая доходность',
    'result.netProfit': 'Чистая прибыль',
    'result.holdingPeriod': 'Период владения',
    'result.totalGain': 'Общий доход/убыток',
    'result.initialInvestment': 'Начальные инвестиции',
    'result.finalValue': 'Конечная стоимость',
    'result.profitable': 'Прибыльная инвестиция',
    'result.progress': 'Прогресс к цели',
    'result.deposits': 'Взносы',
    'result.interestEarned': 'Начисленные проценты',
    'result.totalPayment': 'Общая сумма',
    'result.totalInterest': 'Всего процентов',
    'result.monthlyNeeded': 'Ежемесячные сбережения',
    'result.goalAmount': 'Целевая сумма',
    'result.interestEarned': 'Начисленные проценты',
    'result.totalCost': 'Общая стоимость',
    'result.payoffTime': 'Срок погашения',
    'result.remainingBalance': 'Остаток',
    'result.roi': 'Доходность',
    'result.netProfit': 'Чистая прибыль',
    'result.annualizedROI': 'Годовая доходность',
    'result.principal': 'Основной долг',
    'result.contributions': 'Вложения',
    'result.profit': 'Прибыль',
    
    // Additional Form Labels
    'form.loanAmount': 'Сумма кредита',
    'form.loanTerm': 'Срок кредита',
    'form.targetAmount': 'Целевая сумма',
    'form.initialSavings': 'Начальные сбережения',
    'form.timeframe': 'Срок',
    'form.homePrice': 'Стоимость жилья',
    'form.downPayment': 'Первоначальный взнос',
    'form.currentBalance': 'Текущий баланс',
    'form.annualRate': 'Годовая ставка (APR) %',
    'form.holdingPeriod': 'Период владения',
    'form.homeValue': 'Стоимость недвижимости',
    'form.downPayment': 'Первоначальный взнос',
    'form.loanTerm': 'Срок',
    'form.loanAmount': 'Сумма кредита',
    'form.paymentType': 'Тип платежа',
    'form.initialInvestment': 'Начальные инвестиции',
    'form.finalValue': 'Конечная стоимость',
    'form.targetAmount': 'Целевая сумма',
    'form.initialSavings': 'Начальные сбережения',
    'form.timeframe': 'Временные рамки',
    'form.fixedMonthly': 'Фиксированная месячная сумма',
    'form.extraMonthly': 'Дополнительно ежемесячно',
    'form.fees': 'Комиссии и сборы',
    'form.dividends': 'Полученные дивиденды',
    'form.quickExamples': 'Быстрые примеры',
    'form.apr': 'Годовая ставка (%)',
    'form.monthlyPayment': 'Ежемесячный платёж',
    'form.initialInvestment': 'Начальная инвестиция',
    'form.finalValue': 'Конечная стоимость',
    'form.investmentPeriod': 'Срок инвестиции (месяцев)',
    
    // Chart Titles
    'chart.paymentBreakdown': 'Структура платежей',
    'chart.progressChart': 'График прогресса',
    'chart.amortization': 'Амортизация',
    'chart.balanceOverTime': 'Динамика баланса',
    'chart.investmentBreakdown': 'Структура инвестиции',
    ...
    'button.fullCalculator': 'Полный калькулятор',
    'button.viewAll': 'Смотреть все',
    'button.viewAllNews': 'Все новости',
    'button.readMore': 'Читать →',
    
    // News categories and placeholders - Russian
    'news.markets': 'Рынки',
    'news.investments': 'Инвестиции',
    'news.deposits': 'Вклады',
    'news.realestate': 'Недвижимость',
    'news.crypto': 'Крипто',
    'news.economy': 'Экономика',
    'news.placeholder1.title': 'Обновление денежно-кредитной политики ЦБ',
    'news.placeholder1.desc': 'Последние решения по ключевой ставке и экономический прогноз.',
    'news.placeholder2.title': 'Обзор фондового рынка за день',
    'news.placeholder2.desc': 'Ключевые движения и тренды на рынке акций сегодня.',
    'news.placeholder3.title': 'Лучшие ставки по вкладам в этом месяце',
    'news.placeholder3.desc': 'Сравните лучшие банковские предложения и максимизируйте доход.',
    'news.placeholder4.title': 'Обзор ипотечного рынка',
    'news.placeholder4.desc': 'Текущие ипотечные ставки и анализ условий кредитования.',
    'news.placeholder5.title': 'Обновление рынка криптовалют',
    'news.placeholder5.desc': 'Динамика цен биткоина и основных альткоинов.',
    'news.placeholder6.title': 'Отчёт по экономическим показателям',
    'news.placeholder6.desc': 'Обновление данных по инфляции, ВВП и ключевым метрикам.',
    
    // Article short descriptions - Russian
    'article.compound.short': 'Узнайте, как сложный процент может умножить ваш капитал со временем.',
    'article.savings.short': 'Проверенные методы для накопления денег и достижения финансовых целей.',
    'article.debt.short': 'Сравните методы «лавина» и «снежный ком» для быстрого погашения долгов.',
    'article.mortgage.short': 'Всё, что нужно знать перед покупкой первого жилья.',
    'article.invest.short': 'Начните свой инвестиционный путь с этих базовых концепций.',
    'article.emergency.short': 'Зачем нужен финансовый резерв и как его создать.',
    'article.savings.title': 'Умные Стратегии Накоплений',
    'article.debt.title': 'Стратегии Погашения Долгов',
    'article.mortgage.title': 'Ипотечный Гид для Начинающих',
    'article.invest.title': 'Основы Инвестирования',
    'article.emergency.title': 'Создание Финансовой Подушки',
    
    'form.submit': 'Рассчитать',
    
    // Chart
    'chart.growthTitle': 'График роста',
    'chart.amortization': 'Амортизация',
    'chart.breakdown': 'Структура платежа',
    'chart.savingsGrowth': 'Рост сбережений',
    'chart.balancePayoff': 'Погашение баланса',
    'chart.valueComparison': 'Сравнение стоимости',
    
    // Payment types
    'payment.annuity': 'Аннуитетный (фиксированный)',
    'payment.differentiated': 'Дифференцированный',
    
    // Hints
    'hint.fixedMonthly': 'Установите 0 для автоматического расчета',
    ...
    'section.loan': 'Детали Кредита',
    'section.savings': 'Детали Накоплений',
    'section.mortgage': 'Детали Ипотеки',
    'section.creditcard': 'Детали Кредитной Карты',
    ...
    'section.schedule': 'График Платежей',
    'section.goal': 'Настройки Цели',
    'section.milestones': 'Этапы Накопления',
    'section.extra': 'Дополнительные Платежи',
    'section.extraPayments': 'Дополнительные Платежи',
    'section.paymentHistory': 'История Платежей',
    'section.cardDebt': 'Детали Долга по Карте',
    'section.custom': 'Своя Ежемесячная',
    'section.additionalCosts': 'Дополнительные Расходы',
    'section.comparison': 'Разбивка Затрат',
